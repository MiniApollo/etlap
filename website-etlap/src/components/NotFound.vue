<template>
    <div>
        <h1 class="px-5 text-5xl font-semibold text-center">404</h1>
        <h1 class="px-5 text-4xl font-semibold text-center">A keresett oldal nem létezik</h1>
